    ...
    <div class="LandingSecuritySetup">
        ...
        <el-dialog title="添加常用登录地" :visible.sync="dialogFormVisible1" :close-on-click-modal='false' style="width:1000px;">
          ...
          <div slot="footer" class="dialog-footer">
            <el-button class="f_btn f_btn_l" @click="dialogFormVisible1 = false">取 消</el-button>
        ...
        <el-dialog title="编辑常用登录地" :visible.sync="dialogFormVisible11" :close-on-click-modal='false' style="width:1000px;">
          ...
          <div slot="footer" class="dialog-footer">
            <el-button class="f_btn f_btn_l" @click="dialogFormVisible11 = false">取 消</el-button>
        ...
        <el-dialog title="添加合法登录IP" :visible.sync="dialogFormVisible2" :close-on-click-modal='false' style="width:1000px;">
         <!-- {{addform2}} -->
          ...
          <div slot="footer" class="dialog-footer">
            <el-button class="f_btn f_btn_l" @click="dialogFormVisible2 = false">取 消</el-button>
        ...
        <el-dialog title="编辑合法登录IP" :visible.sync="dialogFormVisible22" :close-on-click-modal='false' style="width:1000px;">
          ...
          <div slot="footer" class="dialog-footer">
            <el-button class="f_btn f_btn_l" @click="dialogFormVisible22 = false">取 消</el-button>
        ...
        <el-dialog title="添加合法登录时间" :visible.sync="dialogFormVisible3" :close-on-click-modal='false' style="width:1000px;">
          ...
          <div slot="footer" class="dialog-footer">
            <el-button class="f_btn f_btn_l" @click="dialogFormVisible3 = false">取 消</el-button>
        ...
        <el-dialog title="编辑合法登录时间" :visible.sync="dialogFormVisible33" :close-on-click-modal='false' style="width:1000px;">
          ...
          <div slot="footer" class="dialog-footer">
            <el-button class="f_btn f_btn_l" @click="dialogFormVisible33 = false">取 消</el-button>
        ...
        <el-dialog title="添加合法登录账号" :visible.sync="dialogFormVisible4" :close-on-click-modal='false' style="width:1000px;">
          ...
          <div slot="footer" class="dialog-footer">
            <el-button class="f_btn f_btn_l" @click="dialogFormVisible4 = false">取 消</el-button>
            <el-button class="f_btn f_btn_r" @click="addExceptionAddLegalUser()">确 定</el-button>
          </div>
        </el-dialog>
        ...
        <el-dialog title="编辑合法登录账号" :visible.sync="dialogFormVisible44" :close-on-click-modal='false' style="width:1000px;">
          ...
          <div slot="footer" class="dialog-footer">
            <el-button class="f_btn f_btn_l" @click="dialogFormVisible44 = false">取 消</el-button>
            <el-button class="f_btn f_btn_r" @click="setLegalConfigServer('4',editTableRow4.legalconfigid)">确 定</el-button>
          </div>
        </el-dialog>
        <!-- 删除 -->
        <el-dialog title="" :visible.sync="centerDialogVisible" :close-on-click-modal='false' style="width:1000px;">
          ...
          <div slot="footer" class="dialog-footer">
            <el-button class="f_btn f_btn_l" @click="centerDialogVisible = false">取 消</el-button>
            <el-button class="f_btn f_btn_r" @click="delExceptionDelLegal(deteleTableUpdate,deteleId)">确 定</el-button>
          </div>
        </el-dialog>
    </div>
</template>
...
import { getProvince, getCity, serverRegion } from "@/api/safety";
