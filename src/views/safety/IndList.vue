      ...
      <div class="mainTable" v-loading = 'loading'>
        <el-table
          ...
          <el-table-column
              ...
              label="告警类型"
              width="110"
              :filters="[{ text: '异地登录', value: '4' },{ text: '爆破登录', value: '5' },{ text: '非法IP登录', value: '1' },{ text: '非法账号登录', value: '3' }, { text: '非法时间登录', value: '2' }  ]"
              :filter-multiple="true"
            column-key = 'filter1'
...
export default {
  ...
  methods: {  
    ...
    filterTag(value, row, column) {
      ...
      let paramStr =
        '<paramStr>{"paramStr":{"currentPage":'+this.currentPage+', "pageSize":'+this.pageSize+',"zoneId":'+this.currentId+',  "status":"0,1", "warningtype":"1,2,3,4" }}</paramStr>';
    ...
    changeRegion(zone,index) {
      ...
      // console.log(zone,22222222222222)
      // console.log(this.currentId,11)
      this.getExceptionList()
    },
    // 获取地区
    getExceptionRegion() {
    ...
    getExceptionList() {
      ...
      let ser = "remoteGetExceptionEventList";
      let paramStr =
        '<paramStr>{"paramStr":{"currentPage":'+this.currentPage+', "pageSize":'+this.pageSize+',"zoneId":'+this.currentId+',  "status":"'+ this.tableStatus +'", "warningtype":"'+this.warningtype+'", "queryParam":"'+this.searchExceList+'"}}</paramStr>';
      exceptionList(ser, paramStr)
        .then(res => {
